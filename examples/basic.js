/**
 * @bullpenm/legal-case-scraper — examples/basic.js
...
async function main() {
    ...
    console.log('@bullpenm/legal-case-scraper v' + (scraper.version || '0.1.0'));
    ...
    const districts = await scraper.getDistricts(session, '24');
    ...
    // console.log('\n--- Party Search ---');
    // const cases = await scraper.searchByParty(session, {
    //     stateCode:    '24',
    //     districtCode: '1',
    //     name:         'Sharma',
    // });
...
main().catch(err => {
    console.error('Error in @bullpenm/legal-case-scraper example:', err.message);
});
