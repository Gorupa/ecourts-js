...
/* ------------------------------------------------
Node compatibility fixes for tlsn-js
------------------------------------------------ */
...
'wss://notary.pse.dev/proxy?node=services.ecourts.gov.in:443';

/* ------------------------------------------------
Generate zkTLS proof for a CNR search
------------------------------------------------ */
...
/* --------------------------------------------
   Extract cookies from Axios cookie jar
-------------------------------------------- */
...
try {
    ...
    await prover.setup({
        ...
        url:
            'https://services.ecourts.gov.in/ecourtindia_v6/case-search',
    ...
    console.log('[zkTLS] Running TLSNotary handshake...');
